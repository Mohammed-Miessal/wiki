                        ...
                        <main class="mt-5 p-12 ml-0 smXl:ml-64 dark:border-gray-700">
                            ...
                            <div class="cards flex flex-wrap justify-center tablet:justify-between gap-6 mb-12">
                                <div class="bg-white dark:bg-gray-800 card border border-[#D9D9DE] dark:border-gray-700 w-full max-w-[20rem] tablet:max-w-[15rem] p-5 rounded-xl">
                                    ...
                                    <div class="data_container flex justify-between">
                                        <div class="left">
                                            ...
                                            <p class="font-bold dark:text-gray-200 text-lg font-inter"> <?php echo $users["COUNT(*)"]; ?> </p>
                                ...
                                <div class="bg-white dark:bg-gray-800 card border border-[#D9D9DE] dark:border-gray-700 w-full max-w-[20rem] tablet:max-w-[15rem] p-5 rounded-xl">
                                    ...
                                    <div class="data_container flex justify-between">
                                        <div class="left">
                                            <p class="font-bold dark:text-gray-200 text-lg font-inter"> <?php echo  $wikis["total"]; ?> </p>
                                ...
                                <div class="bg-white dark:bg-gray-800 card border border-[#D9D9DE] dark:border-gray-700 w-full max-w-[20rem] tablet:max-w-[15rem] p-5 rounded-xl">
                                    ...
                                    <div class="data_container flex justify-between">
                                        <div class="left">
                                            <p class="font-bold dark:text-gray-200 text-lg font-inter"> <?php echo  $wikiPending["pendingTotal"]; ?> </p>
                                            <p class="font-medium text-[#7F7D83] font-lora ">
                                                Total Wikis Pending
                                            </p> 
                                        </div>
                                ...
                                <div class="bg-white dark:bg-gray-800 card border border-[#D9D9DE] dark:border-gray-700 w-full max-w-[20rem] tablet:max-w-[15rem] p-5 rounded-xl">
                                    ...
                                    <div class="data_container flex justify-between">
                                        <div class="left">
                                            <p class="font-bold dark:text-gray-200 text-lg font-inter"> <?php echo  $tags["total"]; ?> </p>
                                            <p class="font-medium text-[#7F7D83] font-lora ">
                                              Total Tags 
                                            </p> 
                                        </div>
                                ...
                                <div class="bg-white dark:bg-gray-800 card border border-[#D9D9DE] dark:border-gray-700 w-full max-w-[20rem] tablet:max-w-[15rem] p-5 rounded-xl">
                                    ...
                                    <div class="data_container flex justify-between">
                                        <div class="left">
                                            <p class="font-bold dark:text-gray-200 text-lg font-inter"> <?php echo  $categories["total"]; ?> </p>
                                            <p class="font-medium text-[#7F7D83] font-lora ">
                                                Total Categories
                                            </p> 
                                        </div>

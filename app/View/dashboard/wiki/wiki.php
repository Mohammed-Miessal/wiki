                                                            ...
                                                            <td class="px-4 py-3 text-center">   
                                                                    ...
                                                                    <td class="px-4 py-3 text-center">
                                                                        <form action="editstatus/edit/<?= $wiki['id'] ?>" method="post">
                                                                            <div class="flex items-center justify-center ">
                                                                                ...
                                                                                <input type="submit" class="bg-grey-500  px-4 py-2.5 rounded-lg cursor-pointer">
                                                                            </div>
                                                                ...
                                                                <?php if ($_SESSION['role_id'] == 1) { ?>
                                                                    <td class="px-4 py-3 text-center  overflow-visible">
                                                                        ...
                                                                        <!-- Dropdown menu -->
                                                                        <div id="<?= $wiki['id'] ?>" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                                                            <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownTopButton">
                                                                                <li>
                                                                                    <!-- <a href="#"> -->
                                                                                    <a href="editwiki/index/<?= $wiki['id'] ?>">

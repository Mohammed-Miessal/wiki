                                                        ...
                                                        <?php foreach ($tags as $tag) { ?>
                                                            ...
                                                            <tr class="border-b dark:border-gray-700">
                                                                ...
                                                                <td class="px-4 py-3 text-center  overflow-visible">
                                                                    ...
                                                                    <!-- Dropdown menu -->
                                                                    <div id="<?= $tag['id'] ?>" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                                                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="<?= $tag['id'] ?>-Button">
                                                                            <li>
                                                                                <!-- <a href="#"> -->
                                                                                <a href="edittag/index/<?= $tag['id'] ?>">
